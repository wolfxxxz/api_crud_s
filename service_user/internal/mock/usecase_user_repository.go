...
func (m *MockUserRepository) UpdateUserPasswordByID(ctx context.Context, req *models.User) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateUserPasswordByID", ctx, req)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUserRepositoryMockRecorder) UpdateUserPasswordByID(ctx, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateUserPasswordByID", reflect.TypeOf((*MockUserRepository)(nil).UpdateUserPasswordByID), ctx, req)
}

// UpdateUserVote mocks base method.
func (m *MockUserRepository) UpdateUserVote(ctx context.Context, votedUser, voterUser *models.User, existingVote *models.Vote) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateUserVote", ctx, votedUser, voterUser, existingVote)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateUserVote indicates an expected call of UpdateUserVote.
func (mr *MockUserRepositoryMockRecorder) UpdateUserVote(ctx, votedUser, voterUser, existingVote interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateUserVote", reflect.TypeOf((*MockUserRepository)(nil).UpdateUserVote), ctx, votedUser, voterUser, existingVote)
}

// UpdateUserVotes mocks base method.
func (m *MockUserRepository) UpdateUserVotes(ctx context.Context, user, votedUser *models.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateUserVotes", ctx, user, votedUser)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateUserVotes indicates an expected call of UpdateUserVotes.
func (mr *MockUserRepositoryMockRecorder) UpdateUserVotes(ctx, user, votedUser interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateUserVotes", reflect.TypeOf((*MockUserRepository)(nil).UpdateUserVotes), ctx, user, votedUser)
}
